...
| **Type** | Validation |
| **Status** | Current |
| **Depends On** | M3-01 through M3-05 (all Done) |
| **Unlocks** | All M4 |
...
| 28 | M3-05 | M3 — Quality Assessment | Done | [Report](IssueReport/M3-05_Implementation_Report.md) | [Tech Doc](IssueReport/M3-05_Technical_Documentation.md) | useNavigateToElement hook, Analyze Impact wired, standardized all transitions |
...
| 28 | M3-05 | M3 — Quality Assessment | 2026-03-19 | [Report](IssueReport/M3-05_Implementation_Report.md) | [Tech Doc](IssueReport/M3-05_Technical_Documentation.md) | useNavigateToElement hook, Analyze Impact wired, all transitions standardized. Разблокировано: M3-06. |
...
- **Завершён:** M3-05 (Cross-Screen Transitions) — shared hook + все transitions wired.
- **Файлы:** `src/ui/hooks/useNavigateToElement.ts` (создан), `GlobalGraphView.tsx` (onAnalyzeImpact), `TableView.tsx` + `CoverageView.tsx` (standardized).
...
- **Новый Current Issue:** M3-06 (Validation: Coverage and Table).
